          ...
          <div className="max-w-md">
            ...
            <SlideIn delay={0.05} y={10}>
              <h2 className="display-2 mt-4">
                Systems shipped, or close to it.
              </h2>
            </SlideIn>
            <FadeIn delay={0.15}>
              <p className="mt-6 text-[var(--color-muted-foreground)] text-pretty">
                We work on a small number of projects at a time. Each one is
                designed to be the kind of system we would defend in front of
                a regulated industry, not a demo.
              </p>
            </FadeIn>
            <FadeIn delay={0.2}>
              <div className="mt-8">
